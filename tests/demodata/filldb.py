...
def insert_data_reports(db):
    ...
    users =[
        "insert into users values (1 , '5d16b83fdb22837e40f93b4abd5dc5865cad08a9', 'Geisel K.'      ,1,  'rspiess@example.net');", 
    ...
    fundorte = [
        "insert into fundorte values (1 , '64027', 'Miesbach', 'Karl Heinz-Ring-Straße','Ville', 'Hamburg', '', '', 1, '10.671282', '52.036639', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (2 , '76960', 'Osterode am Harz', 'Lübsstr. ','Ville', 'Niedersachsen', '', '', 1, '8.480548', '50.777494', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (3 , '17557', 'Kusel', 'Mendestr. ','Ville', 'Bremen', '', '', 1, '8.002667' , '49.039553', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (4 , '73949', 'Bad Mergentheim', 'Stolzestr. ','Ville', 'Hamburg', '', '', 1, '12.241585', '51.746216', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (5 , '38203', 'Niesky', 'Kadestraße ','Ville', 'Saarland', '', '', 1, '10.217125', '50.980799', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (6 , '25639', 'Hünfeld', 'Regine-Junck-Ring ','Ville', 'Schleswig-Holstein', '', '', 1, '11.912951', '51.522037', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (7 , '43619', 'Eichstätt', 'Wenke-Wohlgemut-Ring ','Ville', 'Berlin', '', '', 1, '9.054942' , '52.930573', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (8 , '67355', 'Sangerhausen', 'Marcel-Wernecke-Allee ','Ville', 'Schleswig-Holstein', '', '', 1, '11.129620', '52.884420', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (9 , '13669', 'Gotha', 'Helfried-Holsten-Gasse','Ville', 'Sachsen-Anhalt', '', '', 1, '8.725520' , '49.045359', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (10, '78867', 'Göppingen', 'Briemerallee ','Ville', 'Nordrhein-Westfalen', '', '', 1, '10.922293', '53.113956', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (11, '81160', 'Seelow', 'Imke-Klemt-Straße ','Ville', 'Saarland', '', '', 1, '11.005462', '51.076435', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (12, '51261', 'Uelzen', 'Betina-Bachmann-Allee ','Ville', 'Rheinland-Pfalz', '', '', 1, '10.331594', '53.545572', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (13, '32447', 'Schwerin', 'Paffrathring ','Ville', 'Nordrhein-Westfalen', '', '', 1, '11.281252', '52.694736', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (14, '75971', 'München', 'Eckehard-Eberth-Allee ','Ville', 'Saarland', '', '', 1, '10.053301', '53.430086', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (15, '51366', 'Lübben', 'Kathrin-Eckbauer-Ring ','Ville', 'Berlin', '', '', 1, '12.595564', '51.244785', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (16, '40483', 'Güstrow', 'Fredy-Schüler-Allee ','Ville', 'Sachsen', '', '', 1, '10.200889', '51.180463', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (17, '75034', 'Prenzlau', 'Stumpfring ','Ville', 'Hessen', '', '', 1, '8.050120' , '52.471399', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (18, '95649', 'Neustrelitz', 'Jacobi Jäckelstr. ','Ville', 'Mecklenburg-Vorpommern', '', '', 1, '11.194988', '53.041214', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (19, '85601', 'Feuchtwangen', 'Tlustekring ','Ville', 'Niedersachsen', '', '', 1, '12.819640', '51.769984', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');",
        "insert into fundorte values (20, '34756', 'Jülich', 'Sergei-Naser-Straße ','Ville', 'Bayern', '', '', 1, '10.555141', '53.610359', '2023/2023-01-19/Trebbin_OT_Kleinbeuthen-20230803203653-e99986104029a483763138a30385a1c77bfc5b57.webp');"
    ]
    
    meldungen = [
        "insert into meldungen values (1, NULL, '2021-10-03', NULL, '2025-02-01', NULL, NULL, 1, 1, 0, 0, 0, 0, 1,  'F', '', 'Antworten vielleicht zusammen langsam sind möglich heute. Boden darauf Zeit alle reich Wiese. Jetzt legen Erde möglich jetzt Jahr spät rot.', '');",
        "insert into meldungen values (2, NULL, '2023-08-24', NULL, '2025-02-01', NULL, NULL, 1, 0, 0, 1, 0, 0, 2,  'F', '', 'Das Ball viel. Glauben Schluss rechnen Wetter. Stadt ab Monat Land selbst suchen merken.\nSchreiben Spiel schwer Frage. Junge in Zug nichts Wiese Weihnachten auf.', '');",
        "insert into meldungen values (3, NULL, '2024-04-26', NULL, '2025-02-01', NULL, NULL, 1, 0, 1, 0, 0, 0, 3,  'F', '', 'Gott ihn Finger verstecken Papa Affe. Die dabei Baum antworten.\nZurück mein durch Winter weiter. Ferien früher Baum Sonntag. Hoch schlagen aus.', '');",
        ...
        "insert into meldungen values (5, NULL, '2023-10-18', NULL, '2025-02-02', NULL, NULL, 1, 0, 0, 0, 1, 0, 5,  'F', '', 'Schluss Glas halbe Papa nehmen Monate spielen.\nBeispiel um Wasser Familie verstecken können Wiese also. Dir gefährlich rennen Glück.', '');",
        "insert into meldungen values (6, NULL, '2024-01-28', NULL, '2025-02-02', NULL, NULL, 1, 1, 0, 0, 0, 0, 6,  'F', '', 'Heute Vater natürlich nichts. Kommen nimmt lernen hängen. Es zeigen Schiff zurück bekommen danach Küche. Heiß fressen leise Oma.', '');",
        ...
        "insert into meldungen values (8, NULL, '2023-12-25', NULL, '2025-02-01', NULL, NULL, 1, 0, 0, 0, 1, 0, 8,  'F', '', 'Geschenk weg gehen sieben Maus mit. Schule Bein fragen Wohnung heraus Wald Teller.\nDauern Beispiel Spaß wenig. Vorbei fünf Ende Gott lernen spielen ihn.', '');",
        "insert into meldungen values (9, NULL, '2021-09-30', NULL, '2025-02-01', NULL, NULL, 1, 0, 0, 1, 0, 0, 9,  'F', '', 'Lustig Stück nichts. Onkel neun Katze Baum einigen darauf.\nMann deshalb lassen weg fragen nimmt fröhlich zeigen. Kennen tief Straße überall jetzt Zahl fertig. Haus lange sechs.', '');",
        ...
        "insert into meldungen values (12,NULL, '2021-11-18', NULL, '2025-02-01', NULL, NULL, 1, 0, 0, 0, 1, 0, 12, 'F', '', 'Grün fertig so. Maus ihr schlagen nur damit lernen. Krank schreien zusammen Spiel gleich lesen Weg.\nStelle will das kommen Leben Wagen Abend schlafen. Pferd nein weiter schnell.', '');",
        "insert into meldungen values (13,NULL, '2021-02-12', NULL, '2025-02-01', NULL, NULL, 1, 0, 0, 1, 0, 0, 13, 'F', '', 'Dich ihr Land Garten stellen. Tun kein vor oben.\nSpäter her alle nach Flasche schreien was arbeiten.', '');",
        ...
        "insert into meldungen values (15,NULL, '2024-09-03', NULL, '2025-02-01', NULL, NULL, 1, 0, 1, 0, 0, 0, 15, 'F', '', 'Schicken sonst Mama stellen sagen an.\nHin fertig Spaß blau. Rot treffen mit.\nGleich beißen aus weiter ohne holen Flasche. Glück am gab hier hinter kam.', '');",
        "insert into meldungen values (16,NULL, '2023-10-15', NULL, '2025-02-01', NULL, NULL, 1, 0, 0, 0, 1, 0, 16, 'F', '', 'Zeigen fährt reiten singen so. Neben sonst Name Junge waschen. Dauern schlafen Haare Wasser Flasche. Stelle was dem las wirklich Monat scheinen.', '');",
        ...
        "insert into meldungen values (18,NULL, '2024-12-31', NULL, '2025-02-01', NULL, NULL, 1, 0, 1, 0, 0, 0, 18, 'F', '', 'Schlimm Leute singen ohne zur andere mich Ferien. Wenn sind bleiben sehen Bruder gleich schon ging. Bringen ja man gestern Stein bringen weiß.\nRuhig von Glas immer sein war.', '');",
        "insert into meldungen values (19,NULL, '2024-12-23', NULL, '2025-02-02', NULL, NULL, 1, 0, 0, 0, 1, 0, 19, 'F', '', 'Dann gar Teller schön waschen vor Nase. Lehrer Maus fehlen dann.\nVogel ihm Sommer bis hin schlagen frei.\nAls kochen dir sagen mehr. Fast wenn antworten wer.', '');",
        "insert into meldungen values (20,NULL, '2023-01-20', NULL, '2025-02-01', NULL, NULL, 1, 0, 1, 0, 0, 0, 20, 'F', '', 'hrrad spät müde mit. Zeit zurück Rad mögen den.\nHelfen Loch sonst mich. Aus Stelle allein fiel ließ böse machen. Denn Tag neun bald Rad.', '');"
    ]
