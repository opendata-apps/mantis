...
class TblMeldungen(db.Model):
    ...
    art_m = db.Column(db.String(1), nullable=True)
    art_w = db.Column(db.String(1), nullable=True)
    art_n = db.Column(db.String(1), nullable=True)
    art_o = db.Column(db.String(1), nullable=True)    
